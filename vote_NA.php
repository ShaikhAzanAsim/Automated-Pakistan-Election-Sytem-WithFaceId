...
$sql = "select party.party_id ,party.name,candidate.first_name,candidate.last_name from party INNER join candidate on party.party_id=candidate.party_id where candidate.seat2=(select user.Seat2 from user where user.CNIC='$cnic_check');";

$result = mysqli_query($conn, $sql);
?>

<div class="form-container">
    <h1>CHOOSE THE PARTY YOU WANT TO VOTE FOR IN NATIONAL ASSEMBLY</h1>
    <form id="votingForm" method="post" action="submit_vote_NA.php" onsubmit="return confirmVote()">
        <?php
        if ($result) {
