...
$query= "UPDATE `user` set `vote1` = '$party_id' WHERE cnic = '$cnic_check'";
...
$sql3 = "select candidate.first_name,candidate.last_name from candidate where candidate.seat1=(SELECT user.Seat1 from user where cnic='$cnic_check') and candidate.Party_id='$party_id';";
...
if(mysqli_query($conn, $query)){  
     ...
     $message .= "Your PA vote is for: $vote2\n";
     ...
     $subject = "PROVINCIAL ASSEMBLY VOTE";
     ...
     try {
        ...
        $sql_v = "SELECT vote2 FROM `user` WHERE CNIC = '$cnic_check' ;";
        ...
        if($vote==NULL){
            ...
            echo "click <a href='votechoose_NA.html'>here</a> to continue voting for NATIONAL ASSEMBLY";
        }else{
